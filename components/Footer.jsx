...
const Footer = async () => {
  ...
  return (
    <div className="bg-white rounded-md p-3 mt-5 flex flex-col gap-3">
      <div className="flex flex-col gap-4">
        <h1 className="xl:text-2xl font-semibold">You May Also Like</h1>
        <div className="flex overflow-x-scroll gap-2">
          {data.coins.map((singleCoin) => {
            return (
              <div className="h-[160px] min-w-[252px] rounded-lg p-2 border-2 border-gray-300 flex flex-col gap-1">
